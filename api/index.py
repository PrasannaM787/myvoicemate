...
def top_tier_summary(text):
    ...
    "Something that makes them feel accomplished, capable and steady going forward. "
    ...
    "- Keep the total summary between 120–200 words. Simple. Readable. Valuable. "
    ...
    "- Never use the word 'not just','boundaries', 'journey', 'superstar', 'amazing', or similar hollow words. "
